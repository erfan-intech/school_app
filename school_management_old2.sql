...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2025 at 11:55 AM
...
(48, NULL, NULL, NULL, 66, 'student3-4', '', 3, '2000-01-01', 'female', '', '2025-01-01', 2, NULL, NULL, 'student_68626fb1ab2bb4.26926742.jpeg', '', 0),
(49, NULL, NULL, NULL, 67, 'student3-5', '', 4, '2000-01-01', 'male', '', '2024-01-01', 2, NULL, NULL, 'student_68626e7c4f1089.41379022.jpg', '', 0),
...
ALTER TABLE `class_departments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `class_id` (`class_id`,`department_id`),
  ADD KEY `department_id` (`department_id`);
